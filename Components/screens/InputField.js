...
export default function InputTextField (props) {
  ...
  const [LabelColorUserLocation, setLabelColorUserLocation] = useState (
    '#C2C2C2'
  );
  ...
  const [LabelColorUserMobileNumber, setLabelColorUserMobileNumber] = useState (
    '#C2C2C2'
  );
  const [
    BorderWidthUserMobileNumber,
    setBorderWidthUserMobileNumber,
  ] = useState (1);
  ...
  const [ValidationCheckUserName, setValidationCheckUserName] = useState (
    false
  );
  const [ValidationCheckUserEmil, setValidationCheckUserEmail] = useState (
    false
  );
  const [
    ValidationCheckUserMobileNumber,
    setValidationCheckUserMobileNumber,
  ] = useState (false);
  const [ValidationCheckUserDate, setValidationCheckUserDate] = useState (
    false
  );
  const [ValidationCheckUserGender, setValidationCheckUserGender] = useState (
    false
  );
  const [
    ValidationCheckUserMapLocation,
    setValidationCheckUserMapLocation,
  ] = useState (false);
  const [
    ...
    <View style={{flex: 1}}>
      {ToggleEditButton
        ? <View style={{marginTop: -6}}>
            ...
            <TouchableOpacity
              style={{
                display: props.item.seletedUpdateButton ? 'none' : 'flex',
              }}
